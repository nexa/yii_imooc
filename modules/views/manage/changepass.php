...
<?php echo $form->field($model, 'newpass')->passwordInput(['class' => 'span9']); ?>
<?php echo $form->field($model, 'renewpass')->passwordInput(['class' => 'span9']); ?>

<div class="span11 field-box actions">
  <?php echo Html::submitButton('Change', ['class' => 'btn-glow primary']); ?>
  <span>/</span>
