    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <?php echo $form->field($model, 'adminuser')->hiddenInput(['class' => 'span12', 'placeholder' => 'Admin User']); ?>
                <?php echo $form->field($model, 'adminpass')->passwordInput(['class' => 'span12', 'placeholder' => 'New Admin Password']); ?>
                <?php echo $form->field($model, 'repass')->passwordInput(['class' => 'span12', 'placeholder' => 'Re-new Admin Repassword']); ?>
                <a href="<?php echo yii\helpers\Url::to(['public/login']); ?>" class='forgot'>返回登陆</a>
                <?php echo Html::submitButton('Change Password', ['class' => 'btn-glow primary login']); ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
