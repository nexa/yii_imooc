        ...
        <div class="navbar-inner">
            ...
            <ul class="nav pull-right">                
                ...
                <li class="settings hidden-phone">
                  <a href="<?php echo yii\helpers\Url::to(['manage/changeemail']); ?>" role="button">
                    <i class="icon-cog"></i>
                  </a>
                </li>
                <li class="settings hidden-phone">
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                  ...
                  <li><a href="<?php echo yii\helpers\Url::to(['manage/reg']); ?>">管理员注册</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                  ...
                  <li><a href="<?php echo yii\helpers\Url::to(['user/profile']); ?>">用户信息</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
