    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <?php echo $form->field($model, 'adminuser')->textInput(['class' => 'span12', 'placeholder' => 'Admin User']); ?>
                <?php echo $form->field($model, 'adminemail')->textInput(['class' => 'span12', 'placeholder' => 'Admin Email']); ?>
                <a href="<?php echo yii\helpers\Url::to(['public/login']) ?>" class="forgot">返回登陆</a>
                <?php echo Html::submitButton('Seekpassword', ['class' => 'btn-glow primary login']); ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
